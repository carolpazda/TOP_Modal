...
Ficou alguma dúvida? Eu fiz um vídeo no YouTube explicando um pouco mais sobre o código e mostrando como você pode utilizá-lo, você pode dar uma conferida :point_right: *Colocar assim que estiver pronto* :point_left: <br/>
